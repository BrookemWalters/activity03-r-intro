...
**Response**:
The errors pointed out where the error began. 
...
**Response**: I noticed a new value called "len" and realized I needed to use a different function
...
**Response**:  I noticed that we have 64 characters, and remembered how to assign a sequence. 
...
**Response**: Its' tricky to find errors, but there are usually  couple ways to complete a task
